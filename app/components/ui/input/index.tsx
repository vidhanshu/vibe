...
const inputStyle = tva({
  base: "border-background-100/80 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-primary-700 data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-100/80 items-center",
...
const InputField = React.forwardRef<
  ...
  IInputFieldProps
>(function InputField({ className, hideEye = false, ...props }, ref) {
  ...
  return (
    <>
      <UIInput.Input
        ...
        type={props.type === "password" ? (show ? "text" : "password") : "text"}
      />
      {props.type === "password" && !hideEye && (
        <InputSlot>
          <Pressable onPress={() => setShow(!show)} className="mr-4">
            {show ? (
              <Entypo name="eye" color="white" size={16} />
            ) : (
              <Entypo name="eye-with-line" color="white" size={16} />
            )}
          </Pressable>
        </InputSlot>
      )}
